import{r as e}from"./rolldown-runtime-Dw2cE7zH.js";import{r as t,t as n}from"./react-vendor-CTSggWdF.js";import{t as r}from"./index-B-_9Mh3K.js";import{n as i,t as a}from"./syntax-highlight-DDfxEX0b.js";import{n as o,t as s}from"./LanguageSwitcher-BoZx07nq.js";var c=e(t(),1),l=n();function u({tree:e,activeSection:t,onNavigate:n,isOpen:r,onClose:i}){return(0,l.jsxs)(l.Fragment,{children:[r&&(0,l.jsx)(`div`,{className:`fixed inset-0 bg-black/20 z-40 lg:hidden`,onClick:i}),(0,l.jsx)(`aside`,{className:`
      ...
      `,children:(0,l.jsx)(`nav`,{className:`p-6`,children:Object.entries(e).map(([e,r])=>(0,l.jsxs)(`div`,{className:`mb-6`,children:[(0,l.jsx)(`h3`,{className:`text-xs font-semibold text-stone-400 uppercase tracking-wider mb-3`,children:r.title}),(0,l.jsx)(`ul`,{className:`space-y-1`,children:Object.entries(r.children).map(([e,r])=>(0,l.jsx)(`li`,{children:(0,l.jsx)(`button`,{onClick:()=>{n(e),i()},className:`
                        w-full text-left px-3 py-2 rounded-lg text-sm transition-colors
                        ${t===e?`bg-stone-200 text-stone-900 font-medium`:`text-stone-600 hover:bg-stone-100`}
                      `,children:r})},e))})]},e))})})]})}var d={bash:`bash`,shell:`bash`,sh:`bash`,zsh:`bash`,typescript:`typescript`,ts:`typescript`,javascript:`javascript`,js:`javascript`,python:`python`,py:`python`,rust:`rust`,rs:`rust`,go:`go`,golang:`go`,java:`java`,c:`c`,cpp:`cpp`,"c++":`cpp`,csharp:`csharp`,"c#":`csharp`,ruby:`ruby`,rb:`ruby`,sql:`sql`,json:`json`,yaml:`yaml`,yml:`yaml`,toml:`toml`,markdown:`markdown`,md:`markdown`,html:`html`,css:`css`,scss:`scss`};function f(e){let t=[],n=e,r=0;for(;n.length>0;){let e=n.match(/`([^`]+)`/);if(e&&e.index!==void 0){let i=n.slice(0,e.index);i&&t.push((0,l.jsx)(`span`,{children:f(i)},r++)),t.push((0,l.jsx)(`code`,{className:`bg-stone-100 text-stone-700 px-1.5 py-0.5 rounded text-xs font-mono`,children:e[1]},r++)),n=n.slice(e.index+e[0].length);continue}let i=n.match(/\*\*([^*]+)\*\*/);if(i&&i.index!==void 0){let e=n.slice(0,i.index);e&&t.push((0,l.jsx)(`span`,{children:f(e)},r++)),t.push((0,l.jsx)(`strong`,{className:`font-medium text-stone-900`,children:i[1]},r++)),n=n.slice(i.index+i[0].length);continue}let a=n.match(/\*([^*]+)\*/);if(a&&a.index!==void 0){let e=n.slice(0,a.index);e&&t.push((0,l.jsx)(`span`,{children:f(e)},r++)),t.push((0,l.jsx)(`em`,{className:`italic`,children:a[1]},r++)),n=n.slice(a.index+a[0].length);continue}t.push((0,l.jsx)(`span`,{children:n},r++));break}return t.length>0?t:e}function p({content:e}){let t=e.split(`
`),n=[],r=!1,s=``,c=``,u=!1,p=[];return t.forEach((e,t)=>{if(e.startsWith("```")){if(!r)r=!0,c=e.slice(3).trim()||`text`,s=``;else{r=!1;let e=d[c.toLowerCase()]||c||`text`;n.push((0,l.jsxs)(`div`,{className:`relative group my-4`,children:[(0,l.jsx)(i,{language:e,style:a,customStyle:{margin:0,borderRadius:`0.5rem`,fontSize:`0.875rem`,backgroundColor:`#faf9f6`,border:`1px solid #e7e5e4`},codeTagProps:{style:{fontFamily:`ui-monospace, SFMono-Regular, "SF Mono", Menlo, Monaco, Consolas, monospace`}},children:s}),(0,l.jsx)(o,{text:s})]},t))}return}if(r){s+=(s?`
`:``)+e;return}if(e.startsWith(`|`)){u||(u=!0,p=[]);let t=e.split(`|`).slice(1,-1).map(e=>e.trim());e.includes(`---`)||p.push(t);return}else if(u){u=!1;let e=Math.max(...p.map(e=>e.length));n.push((0,l.jsx)(`div`,{className:`overflow-x-auto my-4`,children:(0,l.jsxs)(`table`,{className:`min-w-full border-collapse`,children:[(0,l.jsx)(`thead`,{children:(0,l.jsx)(`tr`,{children:p[0]?.map((e,t)=>(0,l.jsx)(`th`,{className:`border border-stone-200 px-4 py-2 text-left bg-stone-50 text-sm font-medium`,children:f(e)},t))})}),(0,l.jsx)(`tbody`,{children:p.slice(1).map((t,n)=>(0,l.jsx)(`tr`,{children:Array.from({length:e}).map((e,n)=>(0,l.jsx)(`td`,{className:`border border-stone-200 px-4 py-2 text-sm`,children:f(t[n]||``)},n))},n))})]})},`table-${t}`))}if(e.startsWith(`> `)){n.push((0,l.jsx)(`blockquote`,{className:`border-l-4 border-stone-300 pl-4 py-1 my-3 text-stone-600 text-sm italic`,children:f(e.slice(2))},t));return}if(e.startsWith(`## `)){n.push((0,l.jsx)(`h2`,{className:`text-2xl font-light text-stone-900 mt-8 mb-4`,children:f(e.slice(3))},t));return}if(e.startsWith(`### `)){n.push((0,l.jsx)(`h3`,{className:`text-lg font-medium text-stone-900 mt-6 mb-3`,children:f(e.slice(4))},t));return}if(e.startsWith(`- `)||e.startsWith(`* `)){n.push((0,l.jsx)(`li`,{className:`text-stone-600 text-sm ml-4 mb-1 list-disc`,children:f(e.slice(2))},t));return}let m=e.match(/^(\d+)\.\s/);if(m){n.push((0,l.jsx)(`li`,{className:`text-stone-600 text-sm ml-4 mb-1 list-decimal`,children:f(e.slice(m[0].length))},t));return}e.trim()&&n.push((0,l.jsx)(`p`,{className:`text-stone-600 text-sm leading-relaxed mb-3`,children:f(e)},t))}),(0,l.jsx)(l.Fragment,{children:n})}function m(e){let t=[],n={en:{gettingStarted:[`installation`,`quickStart`,`dataDirectory`],coreFeatures:[`alias`,`report`,`todo`,`script`],aiFeatures:[`aiChat`,`agentMode`,`tools`,`skills`,`hooks`],advanced:[`browser`,`remote`,`permissions`]},zh:{gettingStarted:[`installation`,`quickStart`,`dataDirectory`],coreFeatures:[`alias`,`report`,`todo`,`script`],aiFeatures:[`aiChat`,`agentMode`,`tools`,`skills`,`hooks`],advanced:[`browser`,`remote`,`permissions`]}};return[`gettingStarted`,`coreFeatures`,`aiFeatures`,`advanced`].forEach(r=>{t.push(...n[e][r])}),t}var h={en:{installation:`Installation`,quickStart:`Quick Start`,dataDirectory:`Data Directory`,alias:`Alias Management`,report:`Daily Reports`,todo:`Todo Management`,script:`Script System`,aiChat:`AI Chat`,agentMode:`Agent Mode`,tools:`AI Tools`,skills:`Skill System`,hooks:`Hook System`,browser:`Browser Automation`,remote:`Remote Control`,permissions:`Permissions`},zh:{installation:`安装`,quickStart:`快速上手`,dataDirectory:`数据目录`,alias:`别名管理`,report:`日报系统`,todo:`待办管理`,script:`脚本系统`,aiChat:`AI 对话`,agentMode:`Agent 模式`,tools:`AI 工具`,skills:`Skill 技能`,hooks:`Hook 系统`,browser:`浏览器自动化`,remote:`远程控制`,permissions:`权限配置`}};function g({lang:e,activeSection:t,onNavigate:n}){let r=m(e),i=h[e],a=r.indexOf(t),o=a>0?r[a-1]:null,s=a<r.length-1?r[a+1]:null,c={en:{prev:`Previous`,next:`Next`},zh:{prev:`上一页`,next:`下一页`}}[e];return(0,l.jsxs)(`div`,{className:`flex items-center justify-between py-8 mt-8 border-t border-stone-200`,children:[(0,l.jsx)(`div`,{className:`flex-1`,children:o&&(0,l.jsxs)(`button`,{onClick:()=>n(o),className:`group flex flex-col items-start text-left hover:bg-stone-100 rounded-lg p-3 -ml-3 transition-colors`,children:[(0,l.jsxs)(`span`,{className:`text-xs text-stone-400 mb-1 flex items-center gap-1`,children:[(0,l.jsx)(`svg`,{className:`w-4 h-4`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,strokeWidth:2,children:(0,l.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M15 19l-7-7 7-7`})}),c.prev]}),(0,l.jsx)(`span`,{className:`text-sm font-medium text-stone-700 group-hover:text-stone-900 transition-colors`,children:i[o]})]})}),(0,l.jsx)(`div`,{className:`flex-1 flex justify-end`,children:s&&(0,l.jsxs)(`button`,{onClick:()=>n(s),className:`group flex flex-col items-end text-right hover:bg-stone-100 rounded-lg p-3 -mr-3 transition-colors`,children:[(0,l.jsxs)(`span`,{className:`text-xs text-stone-400 mb-1 flex items-center gap-1`,children:[c.next,(0,l.jsx)(`svg`,{className:`w-4 h-4`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,strokeWidth:2,children:(0,l.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M9 5l7 7-7 7`})})]}),(0,l.jsx)(`span`,{className:`text-sm font-medium text-stone-700 group-hover:text-stone-900 transition-colors`,children:i[s]})]})})]})}var _={en:{gettingStarted:{title:`Getting Started`,children:{installation:`Installation`,quickStart:`Quick Start`,dataDirectory:`Data Directory`}},coreFeatures:{title:`Core Features`,children:{alias:`Alias Management`,report:`Daily Reports`,todo:`Todo Management`,script:`Script System`}},aiFeatures:{title:`AI Features`,children:{aiChat:`AI Chat`,agentMode:`Agent Mode`,tools:`AI Tools`,skills:`Skill System`,hooks:`Hook System`}},advanced:{title:`Advanced`,children:{browser:`Browser Automation`,remote:`Remote Control`,permissions:`Permissions`}}},zh:{gettingStarted:{title:`快速开始`,children:{installation:`安装`,quickStart:`快速上手`,dataDirectory:`数据目录`}},coreFeatures:{title:`核心功能`,children:{alias:`别名管理`,report:`日报系统`,todo:`待办管理`,script:`脚本系统`}},aiFeatures:{title:`AI 功能`,children:{aiChat:`AI 对话`,agentMode:`Agent 模式`,tools:`AI 工具`,skills:`Skill 技能`,hooks:`Hook 系统`}},advanced:{title:`进阶功能`,children:{browser:`浏览器自动化`,remote:`远程控制`,permissions:`权限配置`}}}},v={en:{nav:{back:`← Back to Home`,github:`GitHub`,menu:`Menu`},sections:{installation:{title:`Installation`,content:`## One-click Install (Recommended)
...
rm -rf ~/.jdata
\`\`\``},quickStart:{title:`Quick Start`,content:`## Register App Aliases
...
\`\`\``},report:{title:`Daily Reports`,content:`## Commands
...
\`\`\``},todo:{title:`Todo Management`,content:`## Commands
...
\`\`\``},script:{title:`Script System`,content:`## Commands
...
\`\`\``},aiChat:{title:`AI Chat`,content:`## Starting AI Chat
...
\`\`\``},agentMode:{title:`Agent Mode`,content:`## Overview
...
permissions:
  ...
  deny:
    - Bash
    - Write
\`\`\``},tools:{title:`AI Tools`,content:`## Available Tools
...
\`\`\``},skills:{title:`Skill System`,content:`## Overview
...
\`\`\``},hooks:{title:`Hook System`,content:`## Overview
...
\`\`\``},browser:{title:`Browser Automation`,content:`## Modes
...
- Script injection
- Cookie management
\`\`\``},remote:{title:`Remote Control`,content:`## Overview
...
\`\`\``},permissions:{title:`Permissions`,content:`## Permission Levels
...
permissions:
  - tool: Bash
    ...
    rules:
      ...
      - pattern: "rm -rf /*"
        permission: deny
\`\`\``}}},zh:{nav:{back:`← 返回首页`,github:`GitHub`,menu:`菜单`},sections:{installation:{title:`安装`,content:`## 一键安装（推荐）
...
# （可选）删除数据目录
rm -rf ~/.jdata
\`\`\``},quickStart:{title:`快速上手`,content:`## 注册应用别名
...
# 打开编辑器
j concat edit "code $1"
\`\`\``},aiChat:{title:`AI 对话`,content:`## 启动 AI 对话
...
\`\`\`bash
React 19 有哪些新功能？
\`\`\``},agentMode:{title:`Agent 模式`,content:`## 概述
...
permissions:
  ...
  deny:
    - Bash
    - Write
\`\`\``},tools:{title:`AI 工具`,content:`## 可用工具
...
| \`@url:url\` | 包含网页内容 |
| \`@grep:pattern\` | 包含搜索结果 |
\`\`\``},skills:{title:`Skill 技能`,content:`## 概述
...
- \`doc-gen\`：生成文档
- \`refactor\`：重构建议
\`\`\``},hooks:{title:`Hook 系统`,content:`## 概述
...
\`\`\``},browser:{title:`浏览器自动化`,content:`## 模式
...
- **iOS**：Shortcuts 集成
- **Android**：Tasker 集成
\`\`\``},permissions:{title:`权限配置`,content:`## 权限级别
...
permissions:
  - tool: Bash
    ...
    rules:
      ...
      - pattern: "rm -rf /*"
        permission: deny
\`\`\``}}}};function y(){let[e,t]=(0,c.useState)(`zh`),[n,i]=(0,c.useState)(!1),[a,o]=(0,c.useState)(`installation`),d=v[e],f=_[e];return(0,c.useEffect)(()=>{let e=document.getElementById(a);e&&e.scrollIntoView({behavior:`smooth`,block:`start`})},[a]),(0,l.jsxs)(`div`,{className:`min-h-screen bg-[#faf9f6] text-stone-800`,children:[(0,l.jsx)(`nav`,{className:`fixed top-0 left-0 right-0 z-50 bg-[#faf9f6]/95 backdrop-blur-sm border-b border-stone-200/50`,children:(0,l.jsxs)(`div`,{className:`px-4 sm:px-6 py-4 flex items-center justify-between`,children:[(0,l.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,l.jsx)(`button`,{onClick:()=>i(!n),className:`lg:hidden p-2 -ml-2 text-stone-500 hover:text-stone-900 transition-colors`,children:(0,l.jsx)(`svg`,{className:`w-6 h-6`,fill:`none`,stroke:`currentColor`,viewBox:`0 0 24 24`,strokeWidth:2,children:n?(0,l.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M6 18L18 6M6 6l12 12`}):(0,l.jsx)(`path`,{strokeLinecap:`round`,strokeLinejoin:`round`,d:`M4 6h16M4 12h16M4 18h16`})})}),(0,l.jsxs)(r,{to:`/`,className:`flex items-center gap-2`,children:[(0,l.jsx)(`span`,{className:`text-2xl font-bold text-stone-900`,children:`j`}),(0,l.jsx)(`span`,{className:`text-stone-400 text-sm hidden sm:inline`,children:`docs`})]})]}),(0,l.jsxs)(`div`,{className:`flex items-center gap-3 sm:gap-5`,children:[(0,l.jsx)(s,{lang:e,onChange:t}),(0,l.jsxs)(`a`,{href:`https://github.com/LingoJack/j`,target:`_blank`,rel:`noopener noreferrer`,className:`flex items-center gap-2 text-stone-500 hover:text-stone-900 transition-colors`,children:[(0,l.jsx)(`svg`,{className:`w-5 h-5`,fill:`currentColor`,viewBox:`0 0 24 24`,children:(0,l.jsx)(`path`,{fillRule:`evenodd`,clipRule:`evenodd`,d:`M12 2C6.477 2 2 6.477 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.87 1.52 2.34 1.07 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85v2.74c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0012 2z`})}),(0,l.jsx)(`span`,{className:`text-sm hidden sm:inline`,children:d.nav.github})]})]})]})}),(0,l.jsx)(u,{tree:f,activeSection:a,onNavigate:o,isOpen:n,onClose:()=>i(!1)}),(0,l.jsx)(`main`,{className:`lg:ml-72 pt-[65px]`,children:(0,l.jsxs)(`div`,{className:`max-w-3xl mx-auto px-6 pb-16`,children:[(()=>{let e=d.sections[a];return e?(0,l.jsxs)(`div`,{id:a,className:`py-8`,children:[(0,l.jsx)(`h1`,{className:`text-3xl font-light text-stone-900 mb-6`,children:e.title}),(0,l.jsx)(p,{content:e.content})]}):null})(),(0,l.jsx)(g,{lang:e,activeSection:a,onNavigate:o})]})}),(0,l.jsx)(`footer`,{className:`lg:ml-72 border-t border-stone-200 py-8 px-6 bg-[#faf9f6]`,children:(0,l.jsxs)(`div`,{className:`max-w-3xl mx-auto flex items-center justify-between text-sm`,children:[(0,l.jsx)(r,{to:`/`,className:`text-stone-500 hover:text-stone-900 transition-colors`,children:d.nav.back}),(0,l.jsxs)(`div`,{className:`flex items-center gap-6`,children:[(0,l.jsx)(`a`,{href:`https://github.com/LingoJack/j`,target:`_blank`,rel:`noopener noreferrer`,className:`text-stone-500 hover:text-stone-900 transition-colors`,children:`GitHub`}),(0,l.jsx)(`a`,{href:`https://crates.io/crates/j-cli`,target:`_blank`,rel:`noopener noreferrer`,className:`text-stone-500 hover:text-stone-900 transition-colors`,children:`crates.io`})]})]})})]})}export{y as default};