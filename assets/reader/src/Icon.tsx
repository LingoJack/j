...
export function Settings(props: IconBaseProps) {
  return (
    <svg {...svgProps(props)}>
      ...
      <path d="M19.4 15a1.8 1.8 0 0 0 .36 1.98l.05.05a2.2 2.2 0 1 1-3.11 3.11l-.05-.05a1.8 1.8 0 0 0-1.98-.36 1.8 1.8 0 0 0-1.09 1.65V21.5a2.2 2.2 0 1 1-4.4 0v-.08a1.8 1.8 0 0 0-1.09-1.65 1.8 1.8 0 0 0-1.98.36l-.05.05a2.2 2.2 0 1 1-3.11-3.11l.05-.05A1.8 1.8 0 0 0 3.4 15a1.8 1.8 0 0 0-1.65-1.09H1.7a2.2 2.2 0 1 1 0-4.4h.08A1.8 1.8 0 0 0 3.4 8.42a1.8 1.8 0 0 0-.36-1.98l-.05-.05A2.2 2.2 0 1 1 6.1 3.28l.05.05a1.8 1.8 0 0 0 1.98.36A1.8 1.8 0 0 0 9.22 2.05V1.98a2.2 2.2 0 1 1 4.4 0v.08a1.8 1.8 0 0 0 1.09 1.65 1.8 1.8 0 0 0 1.98-.36l.05-.05a2.2 2.2 0 1 1 3.11 3.11l-.05.05a1.8 1.8 0 0 0-.36 1.98 1.8 1.8 0 0 0 1.65 1.09h.08a2.2 2.2 0 1 1 0 4.4h-.08A1.8 1.8 0 0 0 19.4 15Z" />
    </svg>
  )
}
