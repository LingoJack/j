...
pub fn policy_for(tool_name: &str) -> ToolContextPolicy {
    match tool_name {
        ...
        "EnterPlanMode" | "ExitPlanMode" | "EnterWorktree" | "ExitWorktree" | "Ask"
        | "LoadSkill" | "TodoWrite" | "TodoRead" | "Task" | "Agent" | "AgentTeam"
        | "SendMessage" | "CreateTeammate" => ToolContextPolicy::key_preserve(),
...
mod tests {
    ...
    fn regular_tools_are_placeholder() {
        for name in ["Bash", "Read", "Write", "Edit", "Glob", "Grep", "WebFetch"] {
