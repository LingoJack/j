...
impl ChatApp {
    ...
    pub fn start_archive_confirm(&mut self) {
        use crate::infra::archive::generate_default_archive_name;
    ...
    pub fn start_archive_list(&mut self) {
        use crate::infra::archive::list_archives;
    ...
    pub fn do_archive(&mut self, name: &str) {
        use crate::infra::archive::create_archive;
    ...
    pub fn do_restore(&mut self) {
        use crate::infra::archive::restore_archive;
    ...
    pub fn do_delete_archive(&mut self) {
        use crate::infra::archive::delete_archive;
        ...
        if let Some(archive) = self.ui.archives.get(self.ui.archive_list_index) {
            match delete_archive(&archive.name) {
                Ok(_) => {
                    ...
                    self.ui.archives = crate::infra::archive::list_archives();
